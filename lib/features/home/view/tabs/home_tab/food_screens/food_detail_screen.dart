...
class FoodDetailScreen extends StatelessWidget {
  ...
  Future<void> _deleteMeal(BuildContext context) async {
    ...
    if (confirmed == true) {
      await homeViewModel.deleteMeal(meal);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('food_detail.food_details'.tr(),
            style: TextStyle(
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Text(meal.time,
                    style: TextStyle(fontSize: 14, color: context.lightGrey)),
  ...
  Widget _buildNutritionFactsSection(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("food_detail.nutrition_facts".tr(),
              style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.w700,
                  color: context.textColor)),
          ...
          GridView.builder(
            ...
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                ...
                crossAxisSpacing: 10,
                mainAxisSpacing: 10,
                childAspectRatio: 1.4), // ✅ زيادة النسبة لتجنب التجاوز
            ...
            itemBuilder: (ctx, idx) {
              ...
              return Container(
                ...
                padding:
                    const EdgeInsets.all(10), // ✅ تقليل padding الداخلي قليلاً
                child: Column(
                  mainAxisSize:
                      MainAxisSize.min, // ✅ جعل العمود بحجم المحتوى فقط
