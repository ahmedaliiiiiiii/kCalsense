            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                if (filteredFoods.isNotEmpty)
                  ...
                  _buildEmptyState(
                      context,
                      "home.No_results".tr(namedArgs: {'query': _searchQuery}),
                      Icons.search_off_rounded)
                else
                  _buildEmptyState(context, "home.No_recent_foods_yet".tr(),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 16),
          if (message == "home.No_recent_foods_yet".tr())
            ElevatedButton(
              onPressed: () {
        ...
        child: InkWell(
          ...
          onTap: () {
            ...
            context.pushWithTransition(
              FoodDetailScreen(meal: food, homeViewModel: homeVm),
